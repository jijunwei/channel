...
function privew(title,url,id) {
	...
	if(id=='xsltList'||id=='listPending'||id=="listApprove"){
		url += '&tid='+rowData.id;
	}else{
		url += '&rid='+rowData.id;
	}
	//var openedw=window.open(url,"详情");
	//openedw.focus();
	openwindow(rowData.id,url,rowData.id,680,600);
}
