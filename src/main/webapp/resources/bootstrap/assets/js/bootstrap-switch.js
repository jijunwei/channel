  ...
  (function($, window) {
    ...
    BootstrapSwitch = (function() {
      ...
      BootstrapSwitch.prototype._width = function() {
        ...
        $handles.width(handleWidth-1);      //handleWidth  WUYY
        this.$label.width((function(_this) {
          return function(index, width) {
            ...
            if (width < handleWidth) {
              return handleWidth-8;    //handleWidth  WUYY
            } else {
              return width-8;          //handleWidth  WUYY
            }
          };
        })(this));
        ...
        return this.$wrapper.width(this._handleWidth + this._labelWidth-5);  //this._labelWidth  WUYY
      };
